...
def nacosStart(args:argparse.Namespace):
    ...
    process = subprocess.Popen(
        f'docker exec {args.dockerName} sh /usr/local/scripts/nacosScripts/nacosStart.sh',
        shell=True,
...
def wfServiceStart(args:argparse.Namespace):
    ...
    process = subprocess.Popen(
        f'docker exec {args.dockerName} sh /usr/local/scripts/wfServiceScripts/wfServiceStart.sh',
        shell=True,
        stdout=subprocess.PIPE,
        stderr=subprocess.PIPE,
        text=True) 
